...
export default function ClearTemplateCachePage() {
  ...
  const handleClearCache = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.removeItem("ojs_cache_templates")
      setIsClearing(false)
      setShowDialog(false)
      setCompleted(true)
    ...
    <div className="flex min-h-[calc(100vh-72px)]">
      ...
      <main className="flex-1 bg-[#e8e8e8]">
        ...
        <div className="bg-[#d4d4d4] px-8 py-4 border-b border-[#c0c0c0]">
          <h1 className="text-xl font-semibold text-slate-700">Clear Template Cache</h1>
        </div>
        ...
        <div className="p-8 max-w-2xl">
          <div className="bg-white border border-[#c0c0c0] p-6 space-y-6">
            <p className="text-sm text-slate-600 leading-relaxed">
              Clicking <strong>Clear Template Cache</strong> clears all cached versions of HTML templates. This function
              may be useful to force templates to be reloaded after customizations have been made.
            </p>
      ...
      <AlertDialog open={showDialog} onOpenChange={setShowDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Clear Template Cache?</AlertDialogTitle>
            <AlertDialogDescription>
              This will clear all cached HTML templates. The system will need to recompile templates on next access
              which may temporarily slow down page rendering.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
